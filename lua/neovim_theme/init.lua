...
function M.colorscheme()
	...
	set(0, "SnacksDashboardDesc", { fg = colors.purple })
	set(0, "SnacksDashboardFile", { fg = colors.peach })
	set(0, "SnacksDashboardIcon", { fg = colors.spring })
	set(0, "SnacksDashboardNormal", { link = "Normal" })
	set(0, "SnacksDashboardSpecial", { fg = colors.sky })
	set(0, "SnacksDashboardTitle", { fg = colors.purple })
	set(0, "SnacksDashboardFooter", { fg = colors.lavender })
